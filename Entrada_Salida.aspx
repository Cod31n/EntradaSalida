...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width:135%; background-color:gainsboro; height: 755px;">
            ...
            <asp:Table ID="Table1" runat="server" Width="1669px" >
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:Label ID="LabelEntrada" runat="server" Text="Entrar"/>   
                        ...
                        <asp:Label ID="LabelSalida" runat="server" Text="Salir" Visible="false"/>
                            <asp:ImageButton ID="Salida" runat="server" ImageUrl="~/Resources/salir.jpg" Height="40px" Width="40px" Visible="False"  data-toggle="tooltip" data-placement="bottom" title="Botón para registrar salida" />
